...
echo "create flavor"
openstack flavor create --vcpus 1 --ram 1024 --disk 10 arm-flavor
...
echo "image create"
openstack image create --disk-format qcow2 --min-disk 8 --min-ram 1024 --file ./CentOS-7-x86_64-GenericCloud.qcow2 centos7
